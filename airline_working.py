...
train_data_copy = train_data_copy.groupby(['Month','Distance','Origin_Airport','Destination_Airport','Carrier_ID(DOT)','Tail_Number','Day_of_Month']).apply(replace_none_with_depart_mode).reset_index(drop=True)

print(train_data_copy)
train_data_copy = train_data_copy.groupby(['Month','Distance','Origin_Airport','Destination_Airport','Carrier_ID(DOT)','Tail_Number','Day_of_Month']).apply(replace_none_with_arrival_mode).reset_index(drop=True)    
